...
* @version $Id: papaya_spamfilter.php 37256 2012-07-19 14:30:38Z weinert $
*/

/**
* Database basic access
*/
require_once(PAPAYA_INCLUDE_PATH.'system/base_spamfilter.php');
  ...
  */
  function initializeStopWordDialog() {
    if (!(isset($this->wordDialog) && is_object($this->wordDialog))) {
      ...
      $this->wordDialog->msgs = &$this->msgs;
        ...
        foreach ($tokens as $tokenArray) {
          ...
          if (isset($this->stopWords[$this->logEntry['spamlog_lngid']][$token])) {
            ...
            $result .= sprintf(
              ...
              papaya_strings::escapeHTMLChars($this->images['actions-page-stopword-add']),
          ...
          if (isset($this->ignoreWords[$this->logEntry['spamlog_lngid']][$token])) {
            ...
            $result .= sprintf(
              ...
              papaya_strings::escapeHTMLChars($this->images['actions-page-ignoreword-add']),
