...
* @subpackage Database
* @version $Id: base_db2xml.php 37256 2012-07-19 14:30:38Z weinert $
*/


/**
* database access super class
*/
...
class base_database2xml extends base_db {
  ...
  * @return boolean
  */
  function exportTables2XML($path = './', $prefix = 'table_',
                            $callbackFunc = NULL, $dataTables = NULL) {
