...
* @package Papaya
* @subpackage Core
* @version $Id: base_sitemap.php 37331 2012-08-01 13:07:58Z weinert $
*/
...
class base_sitemap extends base_db {
  ...
  * @param boolean $fields optional, default value FALSE
  * @access public
  */
  ...
  * @access public
  */
  function base_sitemap(&$topic, $fields = FALSE, $baseURL = '', $outputMode = NULL) {
    $this->__construct($topic, $fields, $baseURL, $outputMode);
  }
