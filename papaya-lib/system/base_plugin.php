...
* @package Papaya
* @subpackage Modules
* @version $Id: base_plugin.php 37867 2012-12-17 17:34:22Z weinert $
*/

/**
* XML parser abstraction class
*/
require_once(PAPAYA_INCLUDE_PATH.'system/sys_simple_xmltree.php');
/**
* XSL transformations class
*/
require_once(PAPAYA_INCLUDE_PATH.'system/sys_xsl.php');
/**
* papaya objects superclass
*/
...
class base_plugin extends base_object {
  ...
  * @param mixed string $paramName optional, default value NULL parametername
  * @access public
  */
  ...
  */
  function getPapayaImageTag($str, $width = 0, $height = 0, $alt = '', $resize = NULL,
                             $subTitle = '') {
  ...
  */
  ...
  /**
  * Creates plugin object with base_pluginloader
  *
  * @param string $guid
  * @param object &$parent
  ...
  * @access public
  * @return object base_plugin
  */
  function createPluginObject($guid, $parent, $data = NULL, $class = NULL,
                               $file = NULL, $singleton = FALSE) {
    include_once(PAPAYA_INCLUDE_PATH.'system/base_pluginloader.php');
    return base_pluginloader::getPluginInstance($guid, $parent, $data, $class, $file, $singleton);
  }

  /**
  * Gets plugin data by GUID or GUIDs
  *
  * @param mixed $guids array or string unique identifier(s) of the object classes
  * @access public
  * @return mixed array with plugin data or boolean false
  */
  function getPluginData($guids) {
    include_once(PAPAYA_INCLUDE_PATH.'system/base_pluginloader.php');
    $obj = base_pluginloader::getInstance();
    return $obj->getData($guids);
  }
