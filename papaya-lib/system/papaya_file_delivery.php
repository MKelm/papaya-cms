...
* @package Papaya
* @subpackage Core
* @version $Id: papaya_file_delivery.php 37774 2012-12-04 18:05:42Z weinert $
*/
...
class papaya_file_delivery {
  ...
  * @return boolean
  */
  function outputDownload($localFileName, &$data) {
  ...
  * @return boolean
  */
  function outputFile($localFileName, &$data) {
  ...
  */
  function _closeSession() {
    PapayaApplication::getInstance()->session->close();
  }
}
?>
