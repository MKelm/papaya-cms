...
* @subpackage XML-Feed
* @version $Id: papaya_atom_content.php 37118 2012-06-11 11:19:33Z weinert $
*/
...
class papaya_atom_content extends papaya_atom_text {
  ...
  */
  function assign($content) {
    if (is_object($content) && is_a($content, 'papaya_atom_content')) {
  ...
  */
  function setSrc($src) {
    if (!empty($src)) {
      $this->_value = NULL;
      $this->_src = $this->feed->getAbsoluteHref($src);
      return TRUE;
    }
    return FALSE;
  }
