...
* @subpackage XML-Feed
* @version $Id: papaya_atom_link.php 37118 2012-06-11 11:19:33Z weinert $
*/
...
class papaya_atom_link extends papaya_atom_element {
  ...
  * @access public
  */
  function __construct(papaya_atom_feed $feed, $href, $rel = NULL, $type = NULL,
  ...
  */
  function assign($link) {
    if (is_object($link) && is_a($link, 'papaya_atom_link')) {
