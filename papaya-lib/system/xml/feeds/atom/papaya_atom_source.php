...
* @subpackage XML-Feed
* @version $Id: papaya_atom_source.php 37118 2012-06-11 11:19:33Z weinert $
*/
...
class papaya_atom_source extends papaya_atom_element {
  ...
  *
  * @param papaya_atom_element $source
  * @access public
  * @return papaya_atom_element boolean
  */
  function assign($element) {
    if (is_object($element) && is_a($element, 'papaya_atom_source')) {
      ...
      return TRUE;
    } elseif (is_object($element) && is_a($element, 'papaya_atom_entry')) {
