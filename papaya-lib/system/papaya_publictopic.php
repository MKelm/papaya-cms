...
* @package Papaya
* @subpackage Frontend
* @version $Id: papaya_publictopic.php 38477 2013-05-07 14:27:34Z weinert $
*/


/**
* Basic class papaya_topic
*/
...
class papaya_publictopic extends base_topic {
  ...
  */
  ...
  function getCacheDefinition($pagePlugin) {
    ...
    } elseif ($pagePlugin->cacheable === FALSE) {
