...
* @package Papaya
* @subpackage Core
* @version $Id: base_options.php 38470 2013-04-30 14:56:54Z kersken $
*/
...
class base_options extends base_db {
  ...
  public static $optFields = array(
    ...
    'PAPAYA_LOG_PHP_ERRORLEVEL' => array(
      ...
      array(
        0 => 'None',
        2039 => 'E_ALL ^ E_NOTICE',
        1015 => 'E_ALL ^ (E_NOTICE | E_USER_NOTICE)',
        2047 => 'E_ALL'
      ),
      2047
    ),
  ...
  */
  public static function getInstance($reset = FALSE) {
    return PapayaApplication::getInstance()->options;
  }
  ...
  */
  function defineDatabaseTables() {
    $this->papaya()->options->defineDatabaseTables();
  }
  ...
  */
  function loadAndDefine($loadFromDB = TRUE) {
    return $this->papaya()->options->loadAndDefine();
  }
  ...
  *
  * @param string $name
  * @param scalar $defaultValue returned if not avaliable
  * @return scalar
  */
