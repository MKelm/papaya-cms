...
* @subpackage Database
* @version $Id: base.php 38347 2013-04-02 10:05:29Z weinert $
*/

/**
* available BASIS-class
*/
...
abstract class dbcon_base extends base_object {
  ...
  */
  ...
  /**
  * @var array $databaseConnection Connection-ID
  * @access public
  */
  ...
  * Constructor
  *
  * @param array &$conf Konfiguration
  * @return void
  * @access public
  */
  function __construct(PapayaDatabaseSourceName $conf) {
...
class dbresult_base extends base_object implements PapayaDatabaseResult {
  ...
  * @param resource &$result result ressource
  */
  function dbresult_base(&$connection, &$result, $query) {
    $this->__construct($connection, $result, $query);
  }
  ...
  */
  function absCount() {
    if ($this->_absCount === -1) {
      $this->_absCount = $this->connection->queryRecordCount($this->query);
    }
