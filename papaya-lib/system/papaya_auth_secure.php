...
* @version $Id: papaya_auth_secure.php 36224 2011-09-20 08:00:57Z weinert $
*/
...
*/
require_once(PAPAYA_INCLUDE_PATH.'system/base_auth_secure.php');
      ...
      foreach ($this->loginTries as $try) {
        ...
        if ($try['auth_ip_status'] != 1) {
          $result .= sprintf(
            ...
            papaya_strings::escapeHTMLChars($this->images['status-user-angel']),
        ...
        if ($try['auth_ip_status'] != 2) {
          $result .= sprintf(
            ...
            papaya_strings::escapeHTMLChars($this->images['status-user-evil']),
