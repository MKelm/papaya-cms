...
* @package Papaya
* @subpackage Core
* @version $Id: papaya_publicboxeslinks.php 37996 2013-01-22 11:44:05Z weinert $
*/


/**
* Basic class base_boxeslinks
*/
  ...
  */
  ...
  public function cacheable(PapayaCacheIdentifierDefinition $definition = NULL) {
    if (isset($definition)) {
      ...
      $this->papaya()->plugins->preload($modules);
      foreach ($this->data as $boxData) {
        $plugin = $this->papaya()->plugins->get($boxData['module_guid'], $this->parentObj);
        $plugin->setData($boxData['box_data']);
