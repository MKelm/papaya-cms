...
* @subpackage Ui
* @version $Id: Controller.php 36311 2011-10-13 08:35:14Z roman $
*/
...
class PapayaUiControlCommandController
  ...
  *
  * @param string|array|PapayaRequestParametersName $paramterName
  ...
  *
  * @param NULL|PapayaRequestParametersInterface
