...
class PapayaUiDialog extends PapayaUiControlInteractive {
  ...
  */
  protected function appendHidden(PapayaXmlElement $parent,
  ...
  */
  public function handleValidationFailure(Exception $exception,
                                          PapayaUiDialogField $field) {
    $this->_executionResult = FALSE;
  ...
  *
  * @param PapayaUiDialogOptions $otpions
  */
