...
* @subpackage Ui
* @version $Id: Field.php 37484 2012-08-27 22:21:02Z weinert $
*/
...
abstract class PapayaUiDialogField extends PapayaUiDialogElement {
  ...
  *
  * @param PapayaFilter $defaultValue
  */
  ...
  */
  public function getFilter() {
    if ($this->_mandatory && isset($this->_filter)) {
      ...
      return new PapayaFilterLogicalOr(new PapayaFilterEmpty(), $this->_filter);
    } else {
      return NULL;
    }
  }
  ...
  */
  public function getCurrentValue() {
    ...
    if ($this->hasCollection() &&
      ...
      } elseif ($this->collection()->owner()->data()->has($name)) {
        return $this->collection()->owner()->data()->get($name);
      }
    }
