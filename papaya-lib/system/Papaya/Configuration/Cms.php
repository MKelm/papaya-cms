...
* @version $Id: Cms.php 38470 2013-04-30 14:56:54Z kersken $
*/
...
class PapayaConfigurationCms extends PapayaConfigurationGlobal {
  ...
  */
  public function setupPaths() {
    $this->set('PAPAYA_MODULES_PATH', $this->get('PAPAYA_INCLUDE_PATH').'modules/');
    ...
    case 's3' :
      ...
      include_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Streamwrapper/S3.php');
