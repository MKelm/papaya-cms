...
* @subpackage Filter
* @version $Id: Date.php 38143 2013-02-19 14:58:24Z weinert $
*/
...
class PapayaFilterDate implements PapayaFilter {
  ...
  */
  public function __construct($includeTime = self::DATE_NO_TIME, $step = 60.0) {
