...
* @subpackage Session
* @version $Id: Session.php 38496 2013-05-17 10:32:04Z weinert $
*/
...
class PapayaSession extends PapayaObject {
  ...
  * Getter/Setter for session options object
  *
  * @param PapayaSessionWrapper $options
  ...
  */
  public function isSecureOnly() {
    ...
    if ($options->getOption('PAPAYA_SESSION_SECURE', FALSE)) {
      return TRUE;
    } elseif ($options->getOption('PAPAYA_ADMIN_PAGE', FALSE) &&
              $options->getOption('PAPAYA_UI_SECURE', FALSE)) {
      return TRUE;
    }
    return FALSE;
  }
