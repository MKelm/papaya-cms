...
* @subpackage Request
* @version $Id: Request.php 38316 2013-03-22 16:13:21Z weinert $
*/
...
*/
class PapayaRequest extends PapayaObject {
  ...
  * @return mixed
  */
  public function getParameter($name, $defaultValue = NULL, $filter = NULL,
                        $sources = PapayaRequest::SOURCE_ALL) {
