...
* @subpackage Content
* @version $Id: Tags.php 38396 2013-04-15 16:35:51Z weinert $
*/
...
class PapayaContentPageTags extends PapayaDatabaseObjectList {
  ...
  /**
  * All tag lihnks are saved into one table, the type specified the link group
  *
  * @var string
  */
