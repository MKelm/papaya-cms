...
* @subpackage Database
* @version $Id: Access.php 38361 2013-04-04 12:09:41Z hapke $
*/
...
* @method integer deleteRecord() deleteRecord(string $table, string|array $filter, mixed $value = NULL)
...
* @method integer|NULL insertRecord() insertRecord(string $table, string|NULL $idField, array $values = NULL)
...
* @method boolean query() query(string $sql, integer $max = NULL, integer $offset = NULL, boolean $readOnly = TRUE)
* @method boolean queryFmt() queryFmt(string $sql, array $values, integer $max = NULL, integer $offset = NULL, boolean $readOnly = TRUE)
* @method boolean queryFmtWrite() queryFmtWrite(string $sql, array $values)
* @method boolean queryWrite() queryWrite(string $sql)
* @method integer loadRecord() loadRecord(string $table, array $values, array|string $filter, [mixed $value = NULL])
* @method integer updateRecord() updateRecord(string $table, array $values, array|string $filter, [mixed $value = NULL])
...
class PapayaDatabaseAccess extends PapayaObject {
  ...
  *
  * @param base_db $owner calling object
  ...
  * @return PapayaDatabaseConnectionHandler
  */
  ...
  */
  private function _handleDatabaseException(PapayaDatabaseException $exception) {
    ...
    if (isset($errorHandler)) {
      ...
      $mapSeverity = array(
        PapayaDatabaseException::SEVERITY_INFO => PapayaMessage::TYPE_INFO,
        PapayaDatabaseException::SEVERITY_WARNING => PapayaMessage::TYPE_WARNING,
        PapayaDatabaseException::SEVERITY_ERROR => PapayaMessage::TYPE_ERROR,
      );
