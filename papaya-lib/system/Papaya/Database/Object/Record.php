...
* @subpackage Database
* @version $Id: Record.php 38332 2013-03-27 12:41:33Z weinert $
*/
...
abstract class PapayaDatabaseObjectRecord
  ...
  implements PapayaDatabaseInterfaceRecord, ArrayAccess, IteratorAggregate {
  ...
  * @return boolean
  */
  protected function _loadRecordFromTable($table, $identifier, $value,
                                          $convertRecordCallback = NULL) {
    $fieldNames = array();
