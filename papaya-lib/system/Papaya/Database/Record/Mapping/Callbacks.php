...
* @subpackage Database
* @version $Id: Callbacks.php 37477 2012-08-27 17:25:02Z weinert $
*/
...
* @method scalar onMapValue
* @method mixed onMapValueFromFieldToProperty
* @method scalar onMapValueFromPropertyToField
...
class PapayaDatabaseRecordMappingCallbacks extends PapayaObjectCallbacks {
  ...
  public function __construct() {
    parent::__construct(
      array(
        'onBeforeMapping' => array(),
        'onBeforeMappingFieldsToProperties' => array(),
        'onBeforeMappingPropertiesToFields' => array(),
        'onAfterMapping' => array(),
        'onAfterMappingFieldsToProperties' => array(),
        'onAfterMappingPropertiesToFields' => array(),
        'onMapValue' => NULL,
