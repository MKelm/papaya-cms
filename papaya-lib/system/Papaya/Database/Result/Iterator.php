...
* @subpackage Database
* @version $Id: Iterator.php 36744 2012-02-15 12:02:36Z weinert $
*/
...
class PapayaDatabaseResultIterator implements Iterator {
  ...
  * @param integer $mode
  */
  public function __construct(PapayaDatabaseResult $databaseResult = NULL,
                              $mode = PapayaDatabaseResult::FETCH_ASSOC) {
