...
* @package Papaya
* @subpackage Core
* @version $Id: base_languages.php 36224 2011-09-20 08:00:57Z weinert $
*/
  ...
  */
  function execute() {
    ...
    case 1:
      ...
      break;
    default:
      include_once(PAPAYA_INCLUDE_PATH.'system/base_phraseeditor.php');
      $this->phraseEditor = new base_phraseeditor();
      $this->phraseEditor->layout = &$this->layout;
      $this->phraseEditor->images = &$this->images;
      $this->phraseEditor->msgs = &$this->msgs;
      $this->phraseEditor->authUser = &$this->authUser;
  ...
  */
  function getXML() {
    ...
    case 1:
      ...
      break;
    default:
      return $this->phraseEditor->getXML();
      break;
    }
  }
