...
* @package Papaya
* @subpackage Core
* @version $Id: base_topiclist.php 38168 2013-02-25 10:19:36Z weinert $
*/
...
class base_topiclist extends base_db {
  ...
  * @param boolean $sort optional, default value 0 (ASC)
  * @param integer $max optional, default value 1000
  * @access public
  */
  function loadList($parentTopicId, $lngId, $publishedOnly = TRUE,
                    $sort = 0, $max = 1000, $offset = 0) {
    $this->lngId = $lngId;
  ...
  */
  function loadListByTag($tagId, $lngId, $publishedOnly = TRUE,
                         $sort = 0, $max = 1000, $offset = 0) {
    $this->lngId = $lngId;
    switch ((int)$sort) {
    case self::SORT_DEFAULT_ASCENDING :
  ...
  * Get List
  *
  * @param object base_topic $topicClass
  * @param integer $max optional, default value 1000
  * @access public
