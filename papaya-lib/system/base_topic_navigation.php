...
* @package Papaya
* @subpackage Core
* @version $Id: base_topic_navigation.php 36477 2011-12-03 13:25:26Z weinert $
*/
...
class base_topic_navigation extends base_db {
  ...
  */
  ...
  /**
  * PHP4 constructor pipeline
  *
  * @param object base_topic &$topic
  * @param boolean $fields optional, default value FALSE
  * @access public
  */
  function base_topic_navigation(&$topic, $fields = FALSE) {
    $this->__construct($topic, $fields);
  }
  ...
  * Load navigation
  *
  * @param integer $parentTopicId active topic-ID
  * @access public
  * @return boolean
  */
