...
* @version $Id: papaya_import.php 36224 2011-09-20 08:00:57Z weinert $
*/

/**
* base page import handler class
*/
require_once(PAPAYA_INCLUDE_PATH.'system/base_import.php');
  ...
  function executeFilterLinkEdit($viewId, $filterId) {
    ...
    if ($this->loadFilterLink($viewId, $filterId)) {
      ...
      if (isset($moduleObj) && is_object($moduleObj)) {
        ...
        $moduleObj->setData($this->filterLink['importfilter_data']);
        $hidden = array(
