...
* @version $Id: base_statistic_actions.php 34957 2010-10-05 15:57:41Z weinert $
*/
...
class base_statistic_actions extends base_db_statistic {
  ...
  * @access public
  * @return array $result database results: count, topic_id, categ_id, statistic_moduleaction_params
  */
