...
* @version $Id: base_auth_secure.php 36224 2011-09-20 08:00:57Z weinert $
*/
...
class base_auth_secure extends base_db {
  ...
  */
  function getPasswordHash($password) {
    if (defined('PAPAYA_PASSWORD_PREFIX')) {
      $password = PAPAYA_PASSWORD_PREFIX.$password;
    }
    if (defined('PAPAYA_PASSWORD_SUFFIX')) {
      $password .= PAPAYA_PASSWORD_SUFFIX;
    }
  ...
  */
  function sendNotify($Ip, $countIp, $userName, $countUser) {
    if (defined('PAPAYA_LOGIN_NOTIFYEMAIL') &&
        checkit::isEmail(PAPAYA_LOGIN_NOTIFYEMAIL, TRUE)) {
