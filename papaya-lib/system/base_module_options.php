...
* @package Papaya
* @subpackage Core
* @version $Id: base_module_options.php 37959 2013-01-14 11:48:15Z weinert $
*/

/**
* get the basic database access class
*/
...
class base_module_options extends base_db {
  ...
  * @return string | array
  */
  function readOption($moduleGuid, $optionName, $defaultValue = NULL) {
    $instance = (isset($this) && $this instanceOf self)
      ? $this : base_module_options::getInstance();
  ...
  * @return boolean
  */
  function writeOption($moduleGuid, $optionName, $value) {
    $instance = (isset($this) && $this instanceOf self)
      ? $this : base_module_options::getInstance();
      ...
      if ($res = $this->databaseQueryFmt($sql, $params)) {
        if ($row = $res->fetchRow(DB_FETCHMODE_ASSOC)) {
          if ($row['moduleoption_value'] != $value) {
            $data = array(
              'moduleoption_value' => (string)$value,
