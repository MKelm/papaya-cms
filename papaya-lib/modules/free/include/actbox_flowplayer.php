...
* @version $Id: actbox_flowplayer.php 33004 2009-11-12 09:38:59Z weinert $
...
* @subpackage Free-Include
*/
class actionbox_flowplayer extends base_actionbox {
  ...
  */
  var $editFields = array(
    ...
    'flashfile' => array('Flowplayer file', '#^[a-z\d]{32}$#', TRUE, 'mediafile', 100,
      'Flowplayer media ID', ''),
    'flashmovie' => array('Movie file (flv)', '#^[a-z\d]{32}$#', TRUE, 'mediafile', 100,
  ...
  */
  function getParsedData() {
    ...
    if (!empty($fileName) &&
        ($movie = $mediaDB->getFile($this->data['flashmovie']))) {
