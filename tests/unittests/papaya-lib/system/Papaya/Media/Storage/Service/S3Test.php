...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Media/Storage/Service/S3.php');
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Media/Storage/Service/S3/Handler.php');
...
class PapayaMediaStorageServiceS3Test extends PapayaTestCase {
  ...
  **********************/
  ...
  public function getHeaderCallback($name) {
    ...
    $this->fail('Unknown header name value: '.$name);
  }
