...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Request.php');
  ...
  public function testGetPropertyLanguageInitializeFromOptions() {
    ...
    $request->papaya(
      $this->getMockApplicationObject(
        array(
          'options' => $this->getMockConfigurationObject(array('PAPAYA_CONTENT_LANGUAGE' => 3))
        )
      )
    );
    $this->assertEquals(
  ...
  */
  public function testGetPropertyPageIdFromOptions() {
    ...
    $request->papaya(
      $this->getMockApplicationObject(
        array(
          'options' => $this->getMockConfigurationObject(array('PAPAYA_PAGEID_DEFAULT' => 42))
        )
      )
    );
    $this->assertEquals(42, $request->pageId);
