...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Message/Context/Group.php');
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Message/Context/Interface.php');
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Message/Context/Interface/String.php');
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Message/Context/Interface/Xhtml.php');
