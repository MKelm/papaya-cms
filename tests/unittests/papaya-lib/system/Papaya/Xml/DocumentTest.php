...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Xml/Document.php');
...
class PapayaXmlDocumentTest extends PapayaTestCase {
  ...
  * @covers PapayaXmlDocument::createElementNode
  */
  ...
  */
  public function testLoadXmlWithExternalEntity() {
    $document = new PapayaXmlDocument();
    $document->activateEntityLoader(TRUE);
    $document->loadXml(file_get_contents(__DIR__.'/TestData/xmlWithEntity.xml'));
