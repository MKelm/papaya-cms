...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Ui/Listview/Item.php');
...
class PapayaUiListviewItemTest extends PapayaTestCase {
  ...
  */
  public function testAppendTo() {
    ...
    $item->papaya(
      $this->getMockApplicationObject(array('Images' => array('image' => 'test.gif')))
    );
    $this->assertEquals(
  ...
  */
  public function testAppendToWithEmptyImage() {
    ...
    $item->subitems($subitems);
    $item->papaya(
      $this->getMockApplicationObject(array('Images' => array('image' => '')))
    );
    $this->assertEquals(
