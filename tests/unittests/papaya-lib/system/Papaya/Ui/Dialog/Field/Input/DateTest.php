...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Ui/Dialog/Field/Input/Date.php');
...
class PapayaUiDialogFieldInputDateTest extends PapayaTestCase {
  ...
  * @covers PapayaUiDialogFieldInputDate::__construct
  */
  public function testConstructorWithIncludeTimeOption() {
    try {
      $input = new PapayaUiDialogFieldInputDate(
  ...
  */
  public function testImplicitFilterExpectingTrue($value, $mandatory) {
    $input = new PapayaUiDialogFieldInputDate('Date', 'date', NULL, FALSE,
  ...
  */
  public function testGetXml() {
    ...
    $input->papaya($this->getMockApplicationObject());
    $this->assertEquals(
