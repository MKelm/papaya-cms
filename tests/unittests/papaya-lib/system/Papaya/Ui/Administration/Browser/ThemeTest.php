...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Ui/Administration/Browser/Theme.php');
...
class PapayaUiAdministrationBrowserThemeTest extends PapayaTestCase {
  ...
  */
  public function testGetXmlListViewElement($currentMode, $thumbType, $params, $data, $selected) {
    ...
    $expected = '<listitem'.
      ' href="test.html?test[theme]=theme3&amp;test[mode_view]='.$currentMode.'"'.
  ...
  */
  public function testGetXmlListView() {
    ...
    $themeObject->papaya($this->getMockApplicationObject());
    $themeObject->setThemesPath($path);
  ...
  */
  public function testGetXmlWithThemeInParamsDefaultViewMode() {
    ...
    $expected =
      ...
      ' href="test.html?test[theme]=theme3&amp;test[mode_view]=list" />'.LF.
      '<button hint="Tiles" glyph="/categories-view-tiles.png"'.
      ' href="test.html?test[theme]=theme3&amp;test[mode_view]=tile" />'.LF.
      '<button hint="Thumbnails" glyph="/categories-view-icons.png"'.
      ' href="test.html?test[theme]=theme3&amp;test[mode_view]=thumbs"'.
      ' down="down"/>'.LF.
      '</right>'.LF.'</buttons>'.LF.'<cols>'.LF.'<col>Title / Directory</col>'.LF.
      '</cols>'.LF.'<items>'.LF.
      '<listitem href="test.html?test[theme]=theme1&amp;test[mode_view]=thumbs"'.
      ' title="Theme 1" subtitle="theme1" hint="Theme 1" >'.LF.
      '</listitem>'.LF.
      '<listitem href="test.html?test[theme]=theme2&amp;test[mode_view]=thumbs"'.
      ' title="Theme 2" subtitle="theme2" hint="Theme 2" image="/thumb2_theme2.jpg" >'.LF.
      '</listitem>'.LF.
      '<listitem href="test.html?test[theme]=theme3&amp;test[mode_view]=thumbs"'.
