...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Ui/Toolbar/Paging.php');
...
class PapayaUiToolbarPagingTest extends PapayaTestCase {
  ...
  */
  public function testSetItemsCountResetsCalculations() {
    $paging = new PapayaUiToolbarPaging('foo/page', 30);
    $paging->papaya($this->getMockApplicationObject());
    //trigger calculation
  ...
  public function testGetCurrentPageFromRequest() {
    ...
    $paging->papaya(
      $this->getMockApplicationObject(
        array(
          'Request' => $this->getMockRequestObject(array('page' => 3), 'http://www.test.tld/')
        )
      )
    );
    $this->assertEquals(3, $paging->currentPage);
  ...
  */
  public function testGetCurrentPageFromRequestUsingOffset() {
    ...
    $paging->papaya(
      $this->getMockApplicationObject(
        array(
          'Request' => $this->getMockRequestObject(array('offset' => 20), 'http://www.test.tld/')
        )
      )
    );
    $this->assertEquals(3, $paging->currentPage);
  ...
  */
  public function testGetCurrentPageFromRequestValidatedAndSetToMaximum() {
    ...
    $paging->papaya(
      $this->getMockApplicationObject(
        array(
          'Request' => $this->getMockRequestObject(array('page' => 99), 'http://www.test.tld/')
        )
      )
    );
    $this->assertEquals(3, $paging->currentPage);
  ...
  */
  public function testAppendToWithAdditionalParameters() {
    ...
    $this->assertEquals(
      '<sample>'.
        '<button title="1" href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=1"'.
        ' down="down"/>'.
        '<button title="2" href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=2"/>'.
        '<button title="3" href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=3"/>'.
        '<button glyph="next.png" hint="Next page"'.
        ' href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=2"/>'.
        '<button glyph="last.png" hint="Last page"'.
        ' href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=3"/>'.
        '</sample>',
