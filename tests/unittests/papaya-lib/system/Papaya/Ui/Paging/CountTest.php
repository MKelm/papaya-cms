...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Ui/Paging/Count.php');
...
class PapayaUiPagingCountTest extends PapayaTestCase {
  ...
  */
  public function testAppendToWithAdditionalParameters() {
    ...
    $this->assertEquals(
      '<paging count="3">'.
        '<page href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=1"'.
        ' number="1" selected="selected"/>'.
        '<page href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=2"'.
        ' number="2"/>'.
        '<page href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=3"'.
        ' number="3"/>'.
        '<page href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=2"'.
        ' number="2" type="next"/>'.
        '<page href="http://www.test.tld/test.html?foo[size]=10&amp;foo[page]=3"'.
