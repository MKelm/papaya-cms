...
require_once(PAPAYA_INCLUDE_PATH.'system/Papaya/Administration/Community/Users/List/Dialog.php');
...
class PapayaAdministrationCommunityUsersListDialogTest extends PapayaTestCase {
  ...
  */
  public function testPrepare() {
    ...
    $dialog->prepare($this->getMockApplicationObject());
    $this->assertEquals(
  ...
  */
  public function testCreateUserItem() {
    ...
    $this->assertEquals(
      '<listitem title="test"'.
      ' href="http://www.test.tld/test.html?user_id=42&amp;filter=&amp;page=1"/>',
  ...
  */
  public function testSetParamterNameMapping() {
    ...
    $this->assertEquals(
      '<listitem title="test"'.
      ' href="http://www.test.tld/test.html?surfer_id=42&amp;search=&amp;offset_page=1"/>',
      $dialog->listview()->items[0]->getXml()
    );
  }
